...
async def c1():
    ...
    # asyncio.sleep - неблокирующая функция, которая позволяет приостановить выполнеение корутины
...
async def main2():
    ...
    # await позволяет не завершать функцию main2 сразу, а дождаться выполения c3()
