...
#### Домашнее задание
1. Создайте парараллельный алгоритм для решения одной или нескольких задачи из первого домашнего задания 5-8. Используйте OpenMP и распараллеливание цилов.
...
Отчёт по созданию виртуального окружения Python *(бонусное задание)*: зачем нужно? как сделать? Активировать? Дективировать? На примере одной из своих программ.
