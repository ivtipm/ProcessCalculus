...
#### Бонусное задание
1. Запустите программу для выполнения сети Петри из исходников. Спрашивайте ссылку у преподавателя
2. Доработайте программу
...
Рекомендованная среда разработки - Zed. Не используйте PyCharm или похожую среду разработки для написания кода, ибо автоматическое дополнение и подсказки мешают изучению языка. В Pycharm можно отключить подсказки отдельно или включить режим энергосбережения.
