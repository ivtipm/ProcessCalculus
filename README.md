...
Из-за несовместимых со здравым смыслом требований к материалам, размещаемым на сайте вуза, всё необходимое будет выкладыватся здесь. В том числе слайды лекций, задания для лабораторных работ и домашние задания.
