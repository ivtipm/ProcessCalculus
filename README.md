...
1. Сети Петри [Теория сетей петри и моделирование систем, Питерсон, 1984]
    1. Идея сети Петри. Позиция, переходы, входная и выходная функции.
    1. Маркировка и выполнение сети Петри
    1. Некоторые примеры моделирования с помощью сетей Петри
    1. Анализ сети Петри
