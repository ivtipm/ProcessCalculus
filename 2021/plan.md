...
- построить гистограмму для всех значени в матрице (seaborn)
- построить график любой функции. построить график этой же функции с добавлением шума (numpy, matplotlib)
- 
