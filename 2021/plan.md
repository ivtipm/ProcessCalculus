## Бонусное задание
Создайте кластер из двух или более машин для запуска распределённых вычислений с помошью MPI
...
3. или используйте liveUSB, с возможностью сохранения именений
