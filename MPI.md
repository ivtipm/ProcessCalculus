...
Сообщения могут отправляться непосредственно адресату (большие сообщения) или записываться во временный буфер (маленькие сообщения). Тогда функция отправки сообщения может завершится раньше, чем функция приёма начнёт своё работу.
